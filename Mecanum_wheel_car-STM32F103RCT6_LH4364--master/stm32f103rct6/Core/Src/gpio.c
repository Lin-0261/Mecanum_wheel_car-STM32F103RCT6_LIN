...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, DIN1_Pin|DIN2_Pin|BIN1_Pin|BIN2_Pin
  ...
  /*Configure GPIO pins : E4A_Pin E4B_Pin */
  ...
  /*Configure GPIO pins : DIN1_Pin DIN2_Pin BIN1_Pin BIN2_Pin
                           CIN1_Pin */
  GPIO_InitStruct.Pin = DIN1_Pin|DIN2_Pin|BIN1_Pin|BIN2_Pin
                          |CIN1_Pin;
